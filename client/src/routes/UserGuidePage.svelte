    ...
    <div class="py-8 space-y-8">
      ...
      <div class="text-center">
        ...
        <p class="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Master VocabQuest with these tips and strategies. Let our Explorer Fox
        ...
        <div class="mt-6 flex justify-center">
          <img
            ...
            alt="Explorer Fox"
            class="w-40 h-auto drop-shadow-lg mix-blend-multiply dark:mix-blend-normal"
          />
        </div>
      </div>
        ...
        <div class="p-6 space-y-6">
          ...
          >
            ...
            <img
              ...
              alt=""
              class="w-24 h-auto hidden md:block mix-blend-multiply dark:mix-blend-normal"
            />
          </div>
          ...
          <div class="space-y-6">
            ...
            <div class="border-l-4 border-teal-500 pl-4">
              ...
              <ul class="space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <li class="flex items-start gap-2">
                  <span class="text-teal-500 mt-1">•</span>
                  <span
                    >Mark words as "I Know It" or "Not Yet" to track progress</span
                  >
                </li>
                <li class="flex items-start gap-2">
                  <span class="text-teal-500 mt-1">•</span>
            ...
            <div class="border-l-4 border-blue-500 pl-4">
              <div class="flex items-center gap-2 mb-2">
                ...
                <Badge variant="primary" size="sm">15 XP per card</Badge>
              </div>
              <p class="text-gray-600 dark:text-gray-400 mb-3">
              ...
              <ul class="space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <li class="flex items-start gap-2">
                  <span class="text-blue-500 mt-1">•</span>
                  <span
                    >Earn <strong>15 XP</strong> per correct answer (50% bonus!)</span
                  >
                </li>
              </ul>
            </div>
            ...
            <div class="border-l-4 border-purple-500 pl-4">
              ...
              <ul class="space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <li class="flex items-start gap-2">
                  <span class="text-purple-500 mt-1">•</span>
                  <span
                    >Earn <strong>20 XP</strong> per correct answer (2x bonus!)</span
                  >
                </li>
              </ul>
            </div>
        ...
        <div class="p-6 space-y-6">
          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              <div
                class="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 p-4 rounded-lg"
              >
                ...
                <ul class="space-y-2 text-gray-600 dark:text-gray-400">
                  ...
                  <li class="flex items-start gap-2">
                    <span class="text-orange-500 mt-1">•</span>
                    <span
                      >Increases by <strong>+1 XP</strong> for each consecutive correct
                      answer</span
                    >
                  </li>
                  <li class="flex items-start gap-2">
                  ...
                  <li class="flex items-start gap-2">
                    <span class="text-orange-500 mt-1">•</span>
                    <span
                      ><strong>Example:</strong> On your 5th correct answer in a
                      row, you earn +5 bonus XP</span
                    >
                  </li>
                </ul>
              </div>
            ...
            <div>
              ...
              <div
                class="bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20 p-4 rounded-lg"
              >
                <p class="text-gray-700 dark:text-gray-300 mb-3">
                ...
                <ul class="space-y-2 text-gray-600 dark:text-gray-400">
                  <li class="flex items-start gap-2">
                    ...
                    <span
                      >Earn <strong>+50 XP</strong> when you complete all cards in
                      a set</span
                    >
                  </li>
                  <li class="flex items-start gap-2">
                  ...
                  <li class="flex items-start gap-2">
                    <span class="text-yellow-500 mt-1">•</span>
                    <span
                      >Your completed sets count is tracked during each session</span
                    >
                  </li>
                  <li class="flex items-start gap-2">
                    <span class="text-yellow-500 mt-1">•</span>
                    <span
                      ><strong>Tip:</strong> Cards you answer correctly are removed
                      from the active set</span
                    >
                  </li>
                </ul>
              </div>
            ...
            <div>
              ...
              <p class="text-gray-600 dark:text-gray-400 mb-3">
                Harder words are worth more XP! The system automatically tracks
                which words you struggle with:
              </p>
              <ul class="space-y-2 text-gray-600 dark:text-gray-400">
                <li class="flex items-start gap-2">
                  <span class="text-green-500 mt-1">•</span>
                  <span
                    ><strong>Up to 50% bonus</strong> based on your historical error
                    rate with each word</span
                  >
                </li>
                <li class="flex items-start gap-2">
                  <span class="text-green-500 mt-1">•</span>
                  <span
                    ><strong>20% bonus</strong> for words with very low ease factor
                    (very difficult)</span
                  >
                </li>
                <li class="flex items-start gap-2">
                  <span class="text-green-500 mt-1">•</span>
                  <span
                    ><strong>15% bonus</strong> for words reviewed after 7+ days
                    (long-term retention)</span
                  >
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
              ...
              <div
                class="bg-white dark:bg-gray-700 p-4 rounded border-2 border-teal-500 font-mono text-sm"
              >
              ...
              <p class="text-gray-600 dark:text-gray-400 mt-3 text-sm">
                <strong>Example:</strong> Typing mode (20 XP) + difficult word
                bonus (30%) + 3-card streak (+3) =
      ...
      <Card>
        <div class="p-6 space-y-6">
          ...
          >
            ...
            <img
              src="/assets/mascot/treasure.png"
              alt=""
              class="w-28 h-auto hidden md:block mix-blend-multiply dark:mix-blend-normal"
            />
          </div>

          <div class="space-y-4">
            <p class="text-gray-600 dark:text-gray-400">
              Your level increases as you earn XP. Each new level requires more
              XP than the last:
            </p>

            <div
              class="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-4 rounded-lg"
            >
            ...
            <p class="text-gray-600 dark:text-gray-400">
              <strong>Daily Streak:</strong> Study at least one card each day to
              build your daily streak. The longer your streak, the more consistent
      ...
      <Card>
        <div class="p-6 space-y-4">
          ...
          <div class="space-y-3">
            <div
              class="flex items-start gap-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg"
            >
              <span class="text-2xl">💡</span>
              <div>
                <strong class="text-gray-900 dark:text-white"
                  >Mix up your modes:</strong
                >
            ...
            >
              ...
              <div>
                <strong class="text-gray-900 dark:text-white"
                  >Focus on difficult words:</strong
                >
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                  Check your Stats page to see which words you struggle with
                  most.
                </p>
              </div>
            </div>
            ...
            <div
              class="flex items-start gap-3 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg"
            >
              <span class="text-2xl">🔥</span>
              <div>
                <strong class="text-gray-900 dark:text-white"
                  >Build streaks in Typing mode:</strong
                >
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                  The 2x XP base plus streak bonuses can earn massive points!
                </p>
              </div>
            </div>

            <div
              class="flex items-start gap-3 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg"
            >
              <span class="text-2xl">📅</span>
              <div>
                <strong class="text-gray-900 dark:text-white"
                  >Maintain your daily streak:</strong
                >
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                  Even 5 minutes a day helps build consistency and long-term
                  retention.
                </p>
              </div>
            </div>
            ...
            <div
              class="flex items-start gap-3 p-3 bg-teal-50 dark:bg-teal-900/20 rounded-lg"
            >
              <span class="text-2xl">🔍</span>
              <div>
                <strong class="text-gray-900 dark:text-white"
                  >Use filters strategically:</strong
                >
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                  Filter by part of speech (nouns, verbs, etc.) to focus your
                  study sessions.
                </p>
              </div>
            </div>
