      ...
      <table class="w-full">
        <thead>
          <tr class="border-b border-gray-200 dark:border-gray-700">
            <th
              class="text-left py-2 px-3 text-sm font-medium text-gray-600 dark:text-gray-400"
            >
              Word
            </th>
            <th
              class="text-center py-2 px-3 text-sm font-medium text-gray-600 dark:text-gray-400"
            >
              Part of Speech
            </th>
            <th
